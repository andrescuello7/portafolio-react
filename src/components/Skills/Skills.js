        ...
        <div className="about">
            ...
            <div className="Skills mt-5">
                <div className="SkillsDates">
                    <Card border="secondary p-2 m-2" className="SkillsCard">
                    ...
                    <Card border="secondary p-2 m-2" className="SkillsCard">
                        <div className="d-flex mb-2">
                            <img className="SkillsImgs" src="https://w7.pngwing.com/pngs/604/592/png-transparent-css3-cascading-style-sheets-logo-html-beautify-blue-angle-text.png" />
                            <b>CSS</b>
                        </div>
                        <div>
                            <ProgressBar now={74} label={`${"74"}%`} />
                        </div>
                    </Card>
                    <Card border="secondary p-2 m-2" className="SkillsCard">
                        <div className="d-flex mb-2">
